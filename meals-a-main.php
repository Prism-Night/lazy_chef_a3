...
<body>
    ...
    <main id="home">
        <nav class="side-menu-container">
            <h2 class="head-side-menu">Meals</h2>
            <ul class="side-menu">
        ...
        if (!empty($recipes)): ?>
            <section>
                <h2 class="category-sidemenu">Breakfast</h2>
            ...
            <section>
                <h2 class="category-sidemenu">Main Course</h2>
                <hr class="hr-sidemenu">
                <div class="recipe-grid-sidemenu">
                    <?php foreach ($recipes as $recipe): ?>
                        <article class="recipe-card-sidemenu">
            ...
            <section>
                <h2 class="category-sidemenu">Snacks</h2>
                <hr class="hr-sidemenu">
                <div class="recipe-grid-sidemenu">
                    <?php foreach ($recipes as $recipe): ?>
                        <article class="recipe-card-sidemenu">
            ...
            <section>
                <h2 class="category-sidemenu">Desserts</h2>
                <hr class="hr-sidemenu">
                <div class="recipe-grid-sidemenu">
                    <?php foreach ($recipes as $recipe): ?>
                        <article class="recipe-card-sidemenu">
