...
<body>
    ...
    <main id="home">
        ...
        if (!empty($recipes)): ?>
            <section>
                <h2 class="category-sidemenu">Most Recent</h2>
            ...
            <section>
                <h2 class="category-sidemenu">Top Rated</h2>
                <hr class="hr-sidemenu">
                <div class="recipe-grid-sidemenu">
                    <?php foreach ($recipes as $recipe): ?>
                        <article class="recipe-card-sidemenu">
            ...
            <section>
                <h2 class="category-sidemenu">Favorite</h2>
                <hr class="hr-sidemenu">
                <div class="recipe-grid-sidemenu">
                    <?php foreach ($recipes as $recipe): ?>
                        <article class="recipe-card-sidemenu">
            ...
            <section>
                <h2 class="category-sidemenu">Cuisine</h2>
                <hr class="hr-sidemenu">
                <div class="recipe-grid-sidemenu">
                    <?php foreach ($recipes as $recipe): ?>
                        <article class="recipe-card-sidemenu">
